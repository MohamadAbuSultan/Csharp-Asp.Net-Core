...
لما كنا نتعامل مع قواعد بيانات زي SQL Server أو MySQL أو أي نوع تاني،
كان في حاجة اسمها لغة استعلامات (SQL)، نكتب فيها أوامر علشان نجيب بيانات معينة.

مثلاً:
هاتلي الطلاب اللي ناجحين، هاتلي الموظفين اللي راتبهم فوق 3000 وهكذا.
*/

// طيب! اللينك جابت نفس فكرة الاستعلامات بس داخل الكود نفسه.
// يعني بدل ما تتعامل مع داتابيز، بتتعامل مع ليستات أو آرايز أو كولكشنز جوة الكود كأنهم داتا حقيقية، وتستعلم عنهم بسهولة.
...
يعني لما ضفنا أرقام جديدة، لما عملنا فور لوب تاني، النتيجة تغيرت.
...
بس الميثود سينتاكس مرات أسهل في التعامل خاصة لو بدأت تتعود عليها.
*/
