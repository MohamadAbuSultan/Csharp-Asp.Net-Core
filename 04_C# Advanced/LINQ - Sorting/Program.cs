...
/* آخر مرة أخدنا مقدمة عن اللينك 
* وأنواعه وقلنا إنه في طريقتين لكتابة اللينك: 
* Query Syntax و Method Syntax.
* واتفقنا إنه الطريقتين صح وبطلعوا نفس النتيجة.
* لكن، بعض العمليات في LINQ لازم تستخدم الـ 
* Method Syntax عشان تنفذها، زي بعض عمليات الترتيب.
*/
...
/* ملاحظة:
* بترتيب الميثود، 
* أول حاجة بترتب، بعدين بتفلتر، حسب ترتيب السطور.
* ولو بدك، ممكن تعكسهم حسب الحاجة تبعتك.
* يعني حسب انت بدك ترتب قبل ولا بعد
* الفلترة، حسب المنطق اللي مناسب للكود تبعك.
*/
...
* بس في بعض الشغلات المتقدمة (زي Reverse و Distinct مثلا)
* لازم تشتغل Method Syntax.
*/
